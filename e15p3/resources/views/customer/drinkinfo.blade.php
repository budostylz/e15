    ...
    {{ csrf_field() }}
            ...
            <div class="row">
             ...
             @if(count($barDrinks) == 0)
                ...
                <div dusk='no_drink-input' class="row pt-5">
                    <div class="col-sm">
            ...
            @else
                        ...
                        @foreach( $barDrinks as $index => $drink )
                            ...
                            <div dusk='drink_list-input' class="col-sm">
                                    <input dusk='check_drink-input' type="checkbox" id="{{ $barTitle }}" name="{{ $drink['title'] }}" value="{{ $drink['pivot']['price'] }}">Check to Order
            ...
            <div class="row pt-5">
                ...
                <div class="col-sm ml-5 text-center">
                    ...
                    <button dusk='order_drink-input' type="submit" class="btn btn-primary bg-dark">Order Drinks</button>
